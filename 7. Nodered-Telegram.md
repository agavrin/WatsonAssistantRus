# Лабораторная работа №7. Интеграция Watson Assistant и Telegram с использованием Node-red
  ...
  - [2. Развертывание сервисов Watson](#развертывание-сервисов-watson)
      - [2.1. Создайте сервис IBM Watson Assistant](#markdown-features)
      - [2.2. Создайте сервис IBM Watson Visual Recognition](#wiki-features)
      - [2.3. Создайте сервис IBM Language Translator](#wiki-features)
