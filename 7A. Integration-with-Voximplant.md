# Лабораторная работа №7А. Интеграция Watson Assistant и телефонии с использованием voximplant
...
Список языков для конфигурации: 
Произнесение речи (text-to-spech):
<a href="https://voximplant.com/docs/references/voxengine/language">Базовый список</a>
<a href="https://voximplant.com/docs/references/voxengine/premium">Premium</a>

Распознавание языка:
<a href="https://voximplant.com/docs/references/voxengine/asr/asrlanguage">Базовый список</a>
